...
**Google Drive integration** (`AuthService`, `DriveService`) uses Google Identity Services (GSI) + GAPI loaded dynamically from Google's CDN, scoped to `drive.readonly`, same as legacy.
